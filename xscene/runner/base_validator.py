        ...
        for validation_i in self.cfg.runner.validation_index:
            ...
            for _ in range(self.cfg.runner.validation_times):
                ...
                if self.cfg.runner.validation_show_line:
                    image_with_line = draw_lane_on_imgs(
                        image, val_input["layout_canvas"][0])
                    gen_wl_list.append(concat_6_views(image_with_line))
            ...
            ori_img_wl = concat_6_views(
                draw_lane_on_imgs(ori_imgs, val_input["layout_canvas"][0]))
